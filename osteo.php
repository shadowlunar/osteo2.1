	...
	<div class="row mt-5" >
			<div class="col-4 mt-3">
				<div class="card card-outline-primary">
					<img src="img/OSTEO SIN MAX.jpg" class="card-img-top img-fluid" id="fondo" alt="">		
				</div>
			</div>
				...
				<div class="card " style="background-color:   #F39C12">
					<div class="card-block ">
						...
						<p class="card text-left">
						        ...
						        Dolor de rodillas, hombros, espalda, articulaciones  y gota<br>
						        Inflamación muscular o articular<br> 
						        Dolor por actividad deportiva<br> 
						        Neuralgias(dolores intensos de ojo, cara y cuello)<br> 
						        Reparación y mantenimiento de los diferentes tejidos del cuerpo<br> 
						        Osteoporosis<br> 
						        Calcificación de talón<br> 
						        Espolón<br>
						     	Hernia de disco<br>	
						     	FRASCO CON 35 TABLETAS<br>
